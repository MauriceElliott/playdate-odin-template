...
Json_Decoder :: struct {
	...
	will_decode_sublist:                proc "c" (
		decoder: ^Json_Decoder,
		name: cstring,
		type: Json_Value_Type,
	),
	should_decode_table_value_for_key:  proc "c" (decoder: ^Json_Decoder, key: cstring) -> c.int,
	did_decode_table_value:             proc "c" (
		decoder: ^Json_Decoder,
		key: cstring,
		value: Json_Value,
	),
	should_decode_array_value_at_index: proc "c" (
		decoder: ^Json_Decoder,
		position: c.int,
	) -> c.int,
	did_decode_array_value:             proc "c" (
		decoder: ^Json_Decoder,
		position: c.int,
		value: Json_Value,
	),
	did_decode_sublist:                 proc "c" (
		decoder: ^Json_Decoder,
		name: cstring,
		type: Json_Value_Type,
	),
...
Json_Encoder :: struct {
	...
	write_double:      proc "c" (encoder: ^Json_Encoder, num: f32),
