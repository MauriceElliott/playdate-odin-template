...
Api_Sound_File_Player_Procs :: struct {
	...
	fade_volume:           proc "c" (
		...
		left, right: f32,
		length: i32,
		callback: Sound_Callback_Proc,
	),
	set_mp3_stream_source: proc "c" (
		player: ^File_Player,
		data_source_proc: Sound_Data_Source_Proc,
		user_data: rawptr,
		buffer_length: f32,
	),
}
...
Api_Sound_Sample_Procs :: struct {
	...
	new_sample_from_data: proc "c" (
		data: [^]u8,
		format: Sound_Format,
		sample_rate: u32,
		byte_count: i32,
		should_free_data: b32,
	) -> ^Audio_Sample,
	get_data:             proc "c" (
		sample: ^Audio_Sample,
		data: ^[^]u8,
...
Api_Sound_Sample_Player_Procs :: struct {
	// Extends SoundSource
...
Api_Sound_Signal_Procs :: struct {
	new_signal:           proc "c" (
		step: Signal_Step_Proc,
		note_on: Signal_Note_On_Proc,
		note_off: Signal_Note_Off_Proc,
		dealloc: Signal_Dealloc_Proc,
		user_data: rawptr,
	) -> ^Synth_Signal,
...
LFO_Proc :: #type proc "c" (_: Synth_LFO, _: rawptr) -> f32
...
Api_Sound_Envelope_Procs :: struct {
	new_envelope:             #type proc "c" (
		attack, decay, sustain, release: f32,
	) -> ^Synth_Envelope,
...
Api_Sound_Synth_Procs :: struct {
	...
	set_generator_deprecated: proc "c" (
		synth: ^Synth,
		stereo: b32,
		render: Synth_Render_Proc,
		note_on: Synth_Note_On_Proc,
		release: Synth_Release_Proc,
		set_param: Synth_Set_Parameter_Proc,
		dealloc: Synth_Dealloc_Proc,
		user_data: rawptr,
	),
	set_sample:               proc "c" (
		synth: ^Synth,
		sample: ^Audio_Sample,
		sustain_start, sustain_end: u32,
	),
	...
	play_note:                proc "c" (
		synth: ^Synth,
		frequency, velocity, length: f32,
		_when: u32,
	), // length == -1 for indefinite
	play_midi_note:           proc "c" (
		synth: ^Synth,
		note: MIDI_Note,
		velocity, length: f32,
		_when: u32,
	...
	// 2.2
	set_wavetable:            proc "c" (
		synth: ^Synth,
		sample: ^Audio_Sample,
		log_2_size, columns, rows: i32,
	) -> b32,

	// 2.4
	set_generator:            proc "c" (
		synth: ^Synth,
		stereo: b32,
		render: Synth_Render_Proc,
		note_on: Synth_Note_On_Proc,
		...
		set_param: Synth_Set_Parameter_Proc,
		dealloc: Synth_Dealloc_Proc,
		copy_user_data: Synth_Copy_Userdata_Proc,
		user_data: rawptr,
	),
...
Api_Sound_Instrument_Procs :: struct {
	...
	add_voice:            proc "c" (
		...
		synth: ^Synth,
		range_start, range_end: MIDI_Note,
		transpose: f32,
	) -> b32,
	play_note:            proc "c" (
		inst: ^Synth_Instrument,
...
Api_Sound_Sequence_Procs :: struct {
	...
	set_tempo:            #type proc "c" (seq: ^Sequence, steps_per_second: f32),
	...
	play:                 #type proc "c" (
		seq: ^Sequence,
		finish_callback: Sequence_Finished_Callback,
		user_data: rawptr,
	),
...
Sound_Effect_Proc :: #type proc "c" (
	effect: ^Sound_Effect,
	left, right: ^i32,
	n_samples, buf_active: i32,
) -> i32
...
Api_Sound_Effect_Two_Pole_Filter_Procs :: struct {
	...
	set_type:                 proc "c" (
		filter: ^Sound_Two_Pole_Filter,
		type: Sound_Two_Pole_Filter_Type,
	),
	set_frequency:            proc "c" (filter: ^Sound_Two_Pole_Filter, freq: f32),
	set_frequency_modulator:  proc "c" (
		filter: ^Sound_Two_Pole_Filter,
		signal: ^Synth_Signal_Value,
	),
	...
	set_resonance_modulator:  proc "c" (
		filter: ^Sound_Two_Pole_Filter,
		signal: ^Synth_Signal_Value,
	),
...
Api_Sound_Effect_One_Pole_Filter_Procs :: struct {
	...
	set_parameter_modulator: proc "c" (
		filter: ^Sound_One_Pole_Filter,
		signal: ^Synth_Signal_Value,
	),
...
Api_Sound_Channel_Procs :: struct {
	...
	add_callback_source:  proc "c" (
		channel: ^Sound_Channel,
		callback: Audio_Source_Proc,
		user_data: rawptr,
		stereo: b32,
	) -> ^Sound_Source,
...
Api_Sound_Procs :: struct {
	...
	set_mic_callback:    proc "c" (
		callback: Record_Callback,
		user_data: rawptr,
		source: Sound_Mic_Source,
	),
	...
	// 1.5
	remove_source:       proc "c" (_: ^Sound_Source) -> i32,
